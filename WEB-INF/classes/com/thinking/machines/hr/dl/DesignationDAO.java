...
/*
preparedStatement=connection.prepareStatement("select designation_code from employee where designation_code=?");
preparedStatement.setInt(1,code);
...
title=resultSet.getString("title").trim();// v v v important
designationDTO.setCode(code);
